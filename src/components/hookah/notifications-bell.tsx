...
export function NotificationsBell({ refreshKey }: NotificationsBellProps) {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent
        align="end"
        className="w-[min(92vw,380px)] p-0 overflow-hidden rounded-md"
        sideOffset={8}
      >
        <div className="flex flex-col max-h-[70vh]">
          <div className="flex items-center justify-between px-3 py-2.5 border-b border-border bg-foreground text-background shrink-0">
