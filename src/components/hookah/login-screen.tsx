  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-background px-4 py-8 relative">
      ...
      <div className="relative w-full max-w-sm flex flex-col">
        ...
        <p className="body-sans text-center text-ink-soft mt-4 text-sm">
        ...
        <div className="mt-10 flex flex-col items-center gap-5">
          ...
          >
            {pin.map((d, i) => (
              <Input
                ...
                className={`h-16 w-14 text-center text-3xl font-mono font-bold rounded-none ${
                  error
          ...
          {error && (
            <p className="text-sm text-[#dc2f02] font-mono uppercase tracking-tight fade-in">
              {error}
            </p>
          )}
        ...
        <div className="mt-10 border-t border-border pt-6">
          ...
          <div className="flex flex-col gap-2">
            {demoPins.map((d) => (
              <button
                ...
                disabled={loading}
                className="group flex items-center justify-between border border-border px-3 py-2.5 hover:border-foreground transition-colors disabled:opacity-50"
              >
                <span className="font-mono text-xs uppercase tracking-tight text-ink-soft group-hover:text-foreground">
                  {d.label} · {d.hint}
                </span>
          ...
          <div className="mt-5 flex items-center justify-center gap-1.5 text-[11px] text-ink-faint font-mono uppercase tracking-tight">
      ...
      <p className="absolute bottom-4 left-0 right-0 text-center text-[10px] text-ink-faint font-mono uppercase tracking-tight">
