...
export async function GET(req: NextRequest) {
  try {
    ...
    return NextResponse.json(
      { error: 'Внутренняя ошибка сервера', detail: (e as Error).message },
      { status: 500 },
    )
  }
}
...
export async function POST(req: NextRequest) {
  try {
    ...
    return NextResponse.json(
      { error: 'Не удалось создать поставку', detail: (e as Error).message },
      { status: 500 },
    )
  }
}
...
export async function PATCH(req: NextRequest) {
  try {
    ...
    console.error('PATCH /api/supplies error:', e)
    return NextResponse.json(
      { error: 'Не удалось обновить поставку', detail: (e as Error).message },
      { status: 500 },
    )
  }
}
...
export async function DELETE(req: NextRequest) {
  try {
    ...
    console.error('DELETE /api/supplies error:', e)
    return NextResponse.json(
      { error: 'Не удалось удалить поставку', detail: (e as Error).message },
      { status: 500 },
    )
  }
}
